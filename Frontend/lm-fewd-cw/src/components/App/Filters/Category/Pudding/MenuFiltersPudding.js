...
const FilteredPudding = ({ items }) => {
  const [selectedItems, setSelectedItems] = useState([]);
  //filter criteria
  let filterPudding = items.filter(item => item.category === 'pudding');
  console.log(filterPudding);
...
export default FilteredPudding;
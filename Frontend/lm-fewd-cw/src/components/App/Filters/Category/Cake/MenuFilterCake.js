...
const FilteredCake = ({ items }) => {
  const [selectedItems, setSelectedItems] = useState([]);
  //filter criteria
  let filterCake = items.filter(item => item.category === 'cake');
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-6 submenu">
            ...
            <ul>
              {filterCake.map((item) => (
                //rows and columns don't work properly with cards due to some sort of layout issue, this issue is irrelevant with use of ImgOverlay.
                <Row>
                  <Col>
